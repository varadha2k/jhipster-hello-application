...
@RestController
@RequestMapping("/api/jhipsterhello-kafka")
public class JhipsterhelloKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterhelloKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterhelloKafkaResource(KafkaProperties kafkaProperties) {
